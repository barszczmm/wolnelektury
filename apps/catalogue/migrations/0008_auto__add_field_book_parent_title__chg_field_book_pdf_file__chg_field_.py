...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.parent_title'
        db.add_column(u'catalogue_book', 'parent_title',
                      self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Book.pdf_file'
        db.alter_column(u'catalogue_book', 'pdf_file', self.gf('hybrid_filefield.fields.FileSelectOrUpload')(max_length=200, null=True, match='.*\\.pdf$'))

        # Changing field 'Book.html_file'
        db.alter_column(u'catalogue_book', 'html_file', self.gf('hybrid_filefield.fields.FileSelectOrUpload')(max_length=200, null=True, match='.*\\.html$'))

        # Changing field 'Book.fb2_file'
        db.alter_column(u'catalogue_book', 'fb2_file', self.gf('hybrid_filefield.fields.FileSelectOrUpload')(max_length=200, null=True, match='.*\\.fb2$'))

        # Changing field 'Book.xml_file'
        db.alter_column(u'catalogue_book', 'xml_file', self.gf('hybrid_filefield.fields.FileSelectOrUpload')(max_length=200, null=True, match='.*\\.xml$'))

        # Changing field 'Book.txt_file'
        db.alter_column(u'catalogue_book', 'txt_file', self.gf('hybrid_filefield.fields.FileSelectOrUpload')(max_length=200, null=True, match='.*\\.txt$'))

        # Changing field 'Book.mobi_file'
        db.alter_column(u'catalogue_book', 'mobi_file', self.gf('hybrid_filefield.fields.FileSelectOrUpload')(max_length=200, null=True, match='.*\\.mobi$'))

        # Changing field 'Book.epub_file'
        db.alter_column(u'catalogue_book', 'epub_file', self.gf('hybrid_filefield.fields.FileSelectOrUpload')(max_length=200, null=True, match='.*\\.epub$'))

        # Changing field 'Book.cover'
        db.alter_column(u'catalogue_book', 'cover', self.gf('hybrid_filefield.fields.FileSelectOrUpload')(max_length=200, null=True, match='.*\\.jpg$'))

    def backwards(self, orm):
        # Deleting field 'Book.parent_title'
        db.delete_column(u'catalogue_book', 'parent_title')
    ...
    models = {
        ...
        'catalogue.book': {
            ...
            'cover': ('hybrid_filefield.fields.FileSelectOrUpload', [], {'max_length': '200', 'null': 'True', 'match': "'.*\\\\.jpg$'", 'blank': 'True'}),
            'cover_color': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'epub_file': ('hybrid_filefield.fields.FileSelectOrUpload', [], {'max_length': '200', 'null': 'True', 'match': "'.*\\\\.epub$'", 'blank': 'True'}),
            'extra_info': ('jsonfield.fields.JSONField', [], {'default': "'{}'"}),
            'fb2_file': ('hybrid_filefield.fields.FileSelectOrUpload', [], {'max_length': '200', 'null': 'True', 'match': "'.*\\\\.fb2$'", 'blank': 'True'}),
            'gazeta_link': ('django.db.models.fields.CharField', [], {'max_length': '240', 'blank': 'True'}),
            'html_file': ('hybrid_filefield.fields.FileSelectOrUpload', [], {'max_length': '200', 'null': 'True', 'match': "'.*\\\\.html$'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'pol'", 'max_length': '3', 'db_index': 'True'}),
            'mobi_file': ('hybrid_filefield.fields.FileSelectOrUpload', [], {'max_length': '200', 'null': 'True', 'match': "'.*\\\\.mobi$'", 'blank': 'True'}),
            'number_of_pages': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['catalogue.Book']"}),
            'parent_number': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'parent_title': ('django.db.models.fields.CharField', [], {'max_length': '120', 'null': 'True', 'blank': 'True'}),
            'pdf_file': ('hybrid_filefield.fields.FileSelectOrUpload', [], {'max_length': '200', 'null': 'True', 'match': "'.*\\\\.pdf$'", 'blank': 'True'}),
            'recommended': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '120'}),
            'sort_key': ('django.db.models.fields.CharField', [], {'max_length': '120', 'db_index': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
            'txt_file': ('hybrid_filefield.fields.FileSelectOrUpload', [], {'max_length': '200', 'null': 'True', 'match': "'.*\\\\.txt$'", 'blank': 'True'}),
            'wiki_link': ('django.db.models.fields.CharField', [], {'max_length': '240', 'blank': 'True'}),
            'xml_file': ('hybrid_filefield.fields.FileSelectOrUpload', [], {'max_length': '200', 'null': 'True', 'match': "'.*\\\\.xml$'", 'blank': 'True'}),
