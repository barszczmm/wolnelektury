...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.parent_title'
        db.alter_column(u'catalogue_book', 'parent_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Book.title'
        db.alter_column(u'catalogue_book', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Book.parent_title'
        db.alter_column(u'catalogue_book', 'parent_title', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))

        # Changing field 'Book.title'
        db.alter_column(u'catalogue_book', 'title', self.gf('django.db.models.fields.CharField')(max_length=120))
