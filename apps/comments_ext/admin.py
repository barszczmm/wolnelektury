...
class CommentsExtAdmin(admin.ModelAdmin):
    fieldsets = (
        (None,
        ...
        (_('Metadata'),
           {'fields': ('submit_date', 'ip_address', 'is_private', 'is_public', 'is_removed')}
        ),
     )
    ...
    def get_actions(self, request):
        actions = super(CommentsExtAdmin, self).get_actions(request)
...
admin.site.register(CommentWithPrivate, CommentsExtAdmin)
